...
WHERE date = '2025-03-12'
  AND (time > '00:00:00' AND time <= '12:00:00');
...
SELECT o.pizza_id, SUM(o.quantity * p.price) AS total_revenue FROM order_details o JOIN pizzas p ON o.pizza_id = p.id GROUP BY o.pizza_id;
...
GROUP BY p.id ORDER BY total_quantity DESC 
LIMIT 10;
